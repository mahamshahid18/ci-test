...
var convertHttpRequest = function convertHttpRequest(req) {
    var options = {
        url: req.queryUrl,
        method: req.method,
        headers: req.headers
...
var appendFormdata = function appendFormdata(form, data) {
...
var convertHttpResponse = function convertHttpResponse(resp) {
 ...
 */
var executeRequest = function executeRequest(req, callback) {
    ...
    // Make the request;
    var rq = request(convertedRequest, internalCallback);
