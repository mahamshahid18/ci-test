...
var ResponseTypesController = {
    ...
    getUnixDateTimeArray: function getUnixDateTimeArray(callback) {
        ...
        var _queryBuilder = _baseUri + "/response/unixdatetime";
        ...
        var cb = function cb(_error, _response, _context) {
            ...
            if (_error) {
                ...
                parsed = parsed.map(function parser(dateTimeString) {
    ...
    get1123DateTimeArray: function get1123DateTimeArray(callback) {
        ...
        var _queryBuilder = _baseUri + "/response/1123datetime";
    ...
    getUnixDateTime: function getUnixDateTime(callback) {
        ...
        var cb = function cb(_error, _response, _context) {
            ...
            if (_error) {
                ...
                var _strResult = JSON.parse(_response.body);
                var _result = new Date(_strResult).getTime();
    ...
    get1123DateTime: function get1123DateTime(callback) {
        ...
        var cb = function cb(_error, _response, _context) {
            ...
            if (_error) {
                ...
                var _result = new Date(_strResult).toUTCString();
                callback(null, _result, _context);
            } else {
                errorResponse = _BaseController.validateResponse(_context, "get1123DateTime");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
    ...
    get3339DatetimeArray: function get3339DatetimeArray(callback) {
        ...
        var _queryBuilder = _baseUri + "/response/3339datetime";
    ...
    getModelArray: function getModelArray(callback) {
        ...
        var cb = function cb(_error, _response, _context) {
            ...
            if (_error) {
                ...
                var parsed = JSON.parse(_response.body);
                parsed = parsed.map(function parser(model) {
    ...
    getDate: function getDate(callback) {
        ...
        var _queryBuilder = _baseUri + "/response/date";
        ...
        var cb = function cb(_error, _response, _context) {
            ...
            if (_error) {
                ...
                var _strResult = _response.body;
                var _result = moment(_strResult).format("YYYY-MM-DD");
                callback(null, _result, _context);
            } else {
                errorResponse = _BaseController.validateResponse(_context, "getDate");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
