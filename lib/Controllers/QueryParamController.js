...
const QueryParamController = {
    ...
    urlParam: function urlParam(url, callback) {
        ...
        if (url === null || url === undefined) {
            callback({ errorMessage: 'The parameter `url` is a required parameter and cannot be null.', errorCode: -1 }, null, null);
            return;
        }
        // prepare query string for API call;
        const _baseUri = _configuration.getBaseUri();
    ...
    multipleParams: function multipleParams(number, precision, string, url, callback) {
        ...
        if (number === null || number === undefined) {
            callback({ errorMessage: 'The parameter `number` is a required parameter and cannot be null.', errorCode: -1 }, null, null);
            return;
        } else if (precision === null || precision === undefined) {
            callback({ errorMessage: 'The parameter `precision` is a required parameter and cannot be null.', errorCode: -1 }, null, null);
            return;
        } else if (string === null || string === undefined) {
            callback({ errorMessage: 'The parameter `string` is a required parameter and cannot be null.', errorCode: -1 }, null, null);
            return;
    ...
    simpleQuery: function simpleQuery(mboolean, number, string, queryParameters, callback) {
        ...
        if (mboolean === null || mboolean === undefined) {
            callback({ errorMessage: 'The parameter `mboolean` is a required parameter and cannot be null.', errorCode: -1 }, null, null);
            return;
