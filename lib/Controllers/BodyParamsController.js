...
const BodyParamsController = {
    ...
    sendDynamic: function sendDynamic(dynamic, callback) {
        ...
        if (dynamic === null || dynamic === undefined) {
            callback({ errorMessage: 'The parameter `dynamic` is a required parameter and cannot be null.', errorCode: -1 }, null, null);
            return null;
        }
        // prepare query string for API call;
        const _baseUri = _configuration.getBaseUri();
    ...
    sendStringArray: function sendStringArray(sarray, callback) {
        ...
        if (sarray === null || sarray === undefined) {
            callback({ errorMessage: 'The parameter `sarray` is a required parameter and cannot be null.', errorCode: -1 }, null, null);
            return null;
        }
        // prepare query string for API call;
        const _baseUri = _configuration.getBaseUri();
