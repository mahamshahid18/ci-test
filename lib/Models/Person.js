...
const Person = function Person(obj) {
    if (!obj) {
        ...
        this.birthday = (obj.birthday !== undefined && obj.birthday !== null) ? moment(obj.birthday).format('YYYY-MM-DD') : null;
        this.birthtime = (obj.birthtime !== undefined && obj.birthtime !== null) ? moment(obj.birthtime).parseZone().format() : null;
 ...
 */
Person.prototype.getAddress = function getAddress() {
    return this.address;
};
 ...
 */
Person.prototype.setAddress = function setAddress(value) {
    this.address = value;
};
 ...
 * @return {void}  Doesn't return anything
 */
Person.prototype.setAge = function setAge(value) {
    this.age = value;
};
 ...
 */
Person.prototype.getBirthday = function getBirthday() {
 ...
 * @return {void}  Doesn't return anything
 */
Person.prototype.setBirthday = function setBirthday(value) {
    this.birthday = value;
};
 ...
 */
Person.prototype.getBirthtime = function getBirthtime() {
 ...
 * @return {void}  Doesn't return anything
 */
Person.prototype.setBirthtime = function setBirthtime(value) {
 ...
 * @return {void}  Doesn't return anything
 */
Person.prototype.setName = function setName(value) {
    this.name = value;
};
 ...
 */
Person.prototype.getUid = function getUid() {
    return this.uid;
};
 ...
 * @return {void}  Doesn't return anything
 */
Person.prototype.setUid = function setUid(value) {
    this.uid = value;
};
