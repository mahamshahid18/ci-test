 ...
 *
 * @return dictionary|null  Returns {1} property of EchoResponse class
 */
 ...
 * Setter for Body
 *
 * @param {0} value  Sets the value of body property of EchoResponse class
 ...
 * Setter for Headers
 *
 * @param {0} value  Sets the value of headers property of EchoResponse class
 * @return {void}  Doesn't return anything
 */
 ...
 * TODO: Write general description for this method
 *
 * @return string|null  Returns {1} property of EchoResponse class
 */
 ...
 * Setter for Method
 *
 * @param {0} value  Sets the value of method property of EchoResponse class
 * @return {void}  Doesn't return anything
 */
 ...
 * Setter for Path
 *
 * @param {0} value  Sets the value of path property of EchoResponse class
 * @return {void}  Doesn't return anything
 */
 ...
 * Setter for Query
 *
 * @param {0} value  Sets the value of query property of EchoResponse class
 * @return {void}  Doesn't return anything
 */
 ...
 * TODO: Write general description for this method
 *
 * @return int|null  Returns {1} property of EchoResponse class
 */
 ...
 *
 * @param {0} value  Sets the value of uploadCount property of EchoResponse class
 * @return {void}  Doesn't return anything
 */
