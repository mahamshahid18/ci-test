 ...
 */
var EchoResponse = function EchoResponse(obj) {
    if (!obj) {
        this.body = null;
        this.headers = null;
        this.method = null;
 ...
 */
EchoResponse.prototype.getBody = function getBody() {
    return this.body;
};
 ...
 */
EchoResponse.prototype.setBody = function setBody(value) {
    this.body = value;
};
 ...
 */
EchoResponse.prototype.getHeaders = function getHeaders() {
    return this.headers;
};
 ...
 * @return {void}  Doesn't return anything
 */
EchoResponse.prototype.setHeaders = function setHeaders(value) {
    this.headers = value;
};
 ...
 */
EchoResponse.prototype.getMethod = function getMethod() {
    return this.method;
};
 ...
 * @return {void}  Doesn't return anything
 */
EchoResponse.prototype.setMethod = function setMethod(value) {
    this.method = value;
};
 ...
 */
EchoResponse.prototype.getPath = function getPath() {
    return this.path;
};
 ...
 * @return {void}  Doesn't return anything
 */
EchoResponse.prototype.setPath = function setPath(value) {
    this.path = value;
};
 ...
 */
EchoResponse.prototype.getQuery = function getQuery() {
    return this.query;
};
 ...
 * @return {void}  Doesn't return anything
 */
EchoResponse.prototype.setQuery = function setQuery(value) {
    this.query = value;
};
 ...
 */
EchoResponse.prototype.getUploadCount = function getUploadCount() {
 ...
 * @return {void}  Doesn't return anything
 */
EchoResponse.prototype.setUploadCount = function setUploadCount(value) {
